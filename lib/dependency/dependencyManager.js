...
import { frameworkLibrary, databaseLibrary, ormLibrary, lintLibrary, testLibrary } from './data/index.js';
...
export class DependencyManager {
    ...
    getLintDependencies() {
        ...
        this.getDependenciesFromLibrary(lintKey, lintLibrary);
    }

    getTestDependencies() {
        const testKey = this.project.test.toLowerCase();
        this.getDependenciesFromLibrary(testKey, testLibrary);
    }
}
